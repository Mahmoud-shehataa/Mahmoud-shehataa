...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=FFFFFF&center=true&vCenter=true&width=700&lines=Building+AI+that+ships+to+production;NLP+%7C+LLMs+%7C+Computer+Vision;From+raw+data+to+cloud+deployment;Fine-tuning+LLMs+at+zero+inference+cost)](https://git.io/typing-svg)
